...
SELECT language, rating, mastered, name
FROM programming_languages
INNER JOIN programming_libraries ON programming_languages.id = programming_libraries.languageID;

-- write a LEFT JOIN query on programming_languages & programming_libraries
SELECT language, rating, mastered, name
FROM programming_languages
LEFT JOIN programming_libraries ON programming_languages.id = programming_libraries.languageID;

-- write a RIGHT JOIN query on programming_languages & programming_libraries
SELECT language, rating, mastered, name
FROM programming_languages
RIGHT JOIN programming_libraries ON programming_languages.id = programming_libraries.languageID;
